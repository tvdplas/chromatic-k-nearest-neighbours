...
\begin{figure}[H]
    \begin{center}
        ...
        \subfloat[1D-\{1, 10, 100\}-$k$-100-150-95 ]{
            \resizebox{8cm}{!}{
                \begin{tikzpicture}
                    \begin{axis}[
                            xmode=log,
        ...
        \caption{Naive and fast range query times on 1D artificial instances}
        \label{fig:1dresrangeartificial}
    \end{center}
\end{figure}

\begin{figure}[H]
    \begin{center}
        \subfloat[FRAC uniform and clustered]{
            \resizebox{8cm}{!}{
                \begin{tikzpicture}
                    \begin{axis}[
                            xmode=log,
        ...
        \caption{Naive and fast range query times on 1D FRAC and TMP instances}
        \label{fig:1dresrangearl}
    \end{center}
\end{figure}
