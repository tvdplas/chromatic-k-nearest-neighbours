...
% \newcommand{\fbnote}[1]{{\color{purple}[FEEDBACK NOTE: #1]\\}}
...
\fbnote{Reation to Frank's feedback for renaming scenario's: I didn't get around to doing this as it would mean updating all existing tables + graphs, however I definitely understand why it would be nicer to have shorter names (only thing good about this is uniformity between all generated cases, but it is very long).}
\begin{center}
\begin{table}
