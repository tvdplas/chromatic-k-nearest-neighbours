...
//        Point_d({ 2.4, 4.3 }),
//};
//std::vector<unsigned int> colors = { 0, 1, 2, 3, 4, 5, 6, 7 };
//Point_d q({ 0.0, 2.5 });
//int k = 0;
//
//auto tree = N2D::generate_tree(&locations, &colors);
//auto sorted_x = N2D::generate_sorted_dim(&locations, 0);
//auto sorted_y = N2D::generate_sorted_dim(&locations, 1);
//
//auto distance = N2D::query_k_nearest(&tree, &sorted_x, &sorted_y, q, k);
//std::cout << distance;